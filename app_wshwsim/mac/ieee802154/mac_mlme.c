...
int8_t mac_mlme_start_req(const mlme_start_t *s, struct protocol_interface_rf_mac_setup *rf_mac_setup)
{
    ...
    // Synchronize FHSS
    if (rf_mac_setup->fhss_api && s->PANId != 0xffff) {
...
int8_t mac_mlme_set_req(protocol_interface_rf_mac_setup_s *rf_mac_setup, const mlme_set_t *set_req)
{
    ...
    switch (set_req->attr) {
        ...
        case mac802_15_4Mode:
            ...
            tr_err("Set MAC mode to %s, MTU size: %u", *pu8 == IEEE_802_15_4G_2012 ? "IEEE 802.15.4G-2012" : "IEEE 802.15.4-2011", rf_mac_setup->phy_mtu_size);
            return 0;
        case macTXPower:
            pu8 = (uint8_t *) set_req->value_pointer;
        ...
        case macRfConfiguration:
            ...
            // Also set the CSMA period settings of WISUN here (as a quick workaround)
            mlme_multi_csma_ca_param_t multi_csma_params = {2, 2000};
            ...
            mac_mlme_set_multi_csma_parameters(rf_mac_setup, &set_request);
            return 0;
        default:
