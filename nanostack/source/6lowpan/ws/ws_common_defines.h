...
#define WS_NEIGHBOR_ETX_SAMPLE_MAX 2
#define WS_NEIGHBOR_FIRST_ETX_SAMPLE_MIN_COUNT 1 //This can't be bigger than WS_NEIGHBOR_ETX_SAMPLE_MAX

#define WS_SMALL_PROBE_INIT_BASE_SECONDS 2
